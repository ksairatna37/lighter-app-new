        ...
        >
          ...
          >
            ...
            <div className="text-center pt-8 pb-6 px-6">
              ...
              >
                <h1 className="text-2xl font-bold text-[#A07715] mb-2">Sale Successful!</h1>
                <p className="text-gray-400 text-sm">You've successfully sold your Lighter Points</p>
              </motion.div>
            </div>
            ...
            <motion.div
              ...
              className="px-6 mb-6"
            >
              {/* USDL Received - Main Focus */}
              <div className="bg-card rounded-xl p-4 mb-4">
                <div className="text-center">
                  <div className="flex items-center justify-center gap-2 mb-2">
                    <span className="text-sm text-gray-400">USDL Received</span>
                  </div>
                  <p className="text-4xl font-bold text-[#A07715] mb-1">
                    ${parseFloat(data.usdl_received).toFixed(2)}
                  </p>
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                <div className="bg-card rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-0">
                    <span className="text-xs text-gray-400">Points Sold</span>
                  </div>
                  <p className="text-lg font-bold text-[#D4B679]">
                    {parseFloat(data.points_sold).toFixed(2)}
                  </p>
                </div>
              ...
              <div className="bg-card rounded-xl p-4">
                ...
                <div className="flex justify-between items-center mt-2">
                  ...
                  <span className="text-sm font-bold text-[#D4B679]">
                    {data.price_impact}
                  </span>
                </div>
              </div>
