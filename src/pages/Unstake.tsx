...
const Unstake = () => {
    ...
    const setPercentage = (percentage: number) => {
        const amount = (parseFloat(stakedAmount) * percentage / 100).toFixed(2);
        ...
        try {
            ...
            if (response.status === 200 && response.data?.success) {
                toast({
                    ...
                    description: `Unstaked $${unstakeAmount} USDL successfully`,
                    duration: 2000,
                });
                setUnstakeAmount("");
                refetchBalance?.();
        ...
        <Container className="bg-background min-h-screen pb-24 px-4">
            ...
            >
                <Button
                    ...
                    disabled={!unstakeAmount || parseFloat(unstakeAmount) <= 0 || parseFloat(unstakeAmount) > parseFloat(stakedAmount) || isUnstaking}
                ...
                >
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <span className="text-foreground font-semibold">${(parseFloat(stakedAmount) - parseFloat(unstakeAmount)).toFixed(2)} USDL</span>
                        </div>
                    </div>
                </motion.div>
            )}
