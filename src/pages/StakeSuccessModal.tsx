...
interface StakeSuccessModalProps {
  isOpen: boolean;
  onClose: () => void;
  data: StakeSuccessData | null;
  onStakeAgain?: () => void;
}

const StakeSuccessModal: React.FC<StakeSuccessModalProps> = ({
  isOpen,
  onClose,
  data,
  onStakeAgain
        ...
        >
          ...
          >
            ...
            <div className="text-center pt-8 pb-6 px-6">
              ...
              >
                <h1 className="text-2xl font-bold text-[#A07715] mb-2">Stake Successful!</h1>
                <p className="text-gray-400 text-sm">Your USDL is now earning rewards</p>
              </motion.div>
            </div>
            ...
            >
              ...
              <div className="bg-card rounded-xl p-4 mb-4">
                <div className="text-center">
                  ...
                  <p className="text-4xl font-bold text-[#A07715] mb-1">
                    ${parseFloat(data.staked_amount).toLocaleString()}
                  </p>
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                <div className="bg-card rounded-xl p-4">
                  ...
                  <p className="text-lg font-bold text-[#D4B679]">{data.estimated_apy}</p>
                </div>
                ...
                <div className="bg-card rounded-xl p-4">
                  ...
                  <p className="text-lg font-bold text-[#D4B679]">
                    ${parseFloat(data.estimated_daily_yield).toFixed(4)}
                  </p>
                </div>
              </div>
              ...
              <div className="bg-card rounded-xl p-4 ">
                ...
                <div className="flex justify-between items-center mt-2">
                  ...
                  <span className="text-lg font-bold text-[#D4B679]">
                    ${parseFloat(data.total_staked).toLocaleString()}
                  </span>
                </div>
              </div>
            </motion.div>
